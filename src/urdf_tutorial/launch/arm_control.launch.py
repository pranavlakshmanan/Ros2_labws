...
def generate_launch_description():
    ...
    controller_file = '/home/pranavlakshmanan/ros2_ws/src/urdf_tutorial/config/control.yaml'
    robot_description = {"robot_description": urdf_file}

    # Include Gazebo launch file
    gazebo = IncludeLaunchDescription(
        PythonLaunchDescriptionSource("/home/pranavlakshmanan/ros2_ws/src/urdf_tutorial/launch/arm_gazebo.launch.py"),
    )
